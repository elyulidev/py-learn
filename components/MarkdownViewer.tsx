...
import { Copy, Check, Info, Terminal, Hash } from "lucide-react";
				...
				components={{
					...
					h1: ({ children, ...props }) => (
						<div className='mb-8 pb-4 border-b border-gray-200 dark:border-gray-700'>
							<h1
								className='text-3xl md:text-4xl font-extrabold text-primary-700 dark:text-primary-400 tracking-tight'
								{...props}
							>
								{children}
							</h1>
					...
					h2: ({ children, ...props }) => (
						<h2
							className='text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100 mt-12 mb-6 flex items-center'
							{...props}
						>
					...
					h3: ({ children, ...props }) => (
						<h3
							className='text-xl font-semibold text-primary-600 dark:text-primary-300 mt-8 mb-4 flex items-center'
							{...props}
						>
					...
					ol: ({ children, ...props }) => (
						<ol
							className='list-decimal space-y-3 mb-6 ml-6 text-gray-700 dark:text-gray-300 font-medium'
							{...props}
						>
							{children}
						</ol>
					...
					li: ({ children, ...props }) => (
						<li
							className='text-gray-700 dark:text-gray-300 pl-2 relative flex items-start'
							{...props}
						>
							<span className='mr-2 mt-1.5 min-w-1.5 h-1.5 rounded-full bg-primary-400 dark:bg-primary-500 shrink-0 block md:hidden'></span>
