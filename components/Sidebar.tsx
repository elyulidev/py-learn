			...
			>
				<div className='p-6 sticky top-0 bg-white dark:bg-gray-900 z-10 border-b border-gray-100 dark:border-gray-800'>
					<div className='flex items-center space-x-2 text-primary-600 dark:text-primary-400'>
						...
						<span className='text-xl font-bold tracking-tight'>PyLearn</span>
					</div>
					<p className='text-xs text-gray-500 dark:text-gray-400 mt-2'>
						Aprende Python de forma educativa e simples
					</p>
				</div>
				...
				<nav className='p-4 pb-24 space-y-1'>
                    ...
                    ${
											isExpanded
												...
												: "hover:bg-gray-50 dark:hover:bg-gray-800/30 rounded-lg"
										}
                  `}
								>
									<span
                          ...
                          `}
												>
													<div className='flex items-center overflow-hidden'>
														<Book
															size={16}
															className={`mr-3 flex-shrink-0 ${getIconColor(
																topic.difficulty
															)} transition-opacity ${
																currentTopicId === topic.id
																	? "opacity-100"
