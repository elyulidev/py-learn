...
export const getLessonContent = async (topic: Topic): Promise<string> => {
  ...
  // Simula um pequeno delay de rede para sensação de carregamento (opcional, pode remover)
...
export const askTutor = async (question: string, currentContext: string): Promise<string> => {
  try {
